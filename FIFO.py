...
class FIFO:
    ...
    def update_table(self):
        ...
        run_button = tk.Button(self.input_frame, text="Run FIFO",width=15, font=('Helvetica', 14), anchor="center", bg="#F7E59D", fg="black", command=self.Calculate_FIFO)
    ...
    def fifo(self, job_list):
        ...
        while job_list:
            if job_list[0][0] > time:
                ...
                tat = ct - job[0]
                wt = tat - job[1]
                gantt.append((job_name, job[0], starting_time, ct))
                timeline.append((job_name, job[0],starting_time, ct))
                completed[job_name] = [job[0], job[1], ct, tat, wt]
        return gantt, completed, timeline, time
    ...
    def Calculate_FIFO(self):
        ...
        try:
            ...
            solution_window.configure(bg="#D2F4F5")
        ...
        gantt, completed, timeline,_ = self.fifo(process_list)
        ...
        for task, arrival_time, start_time, ct in gantt:
